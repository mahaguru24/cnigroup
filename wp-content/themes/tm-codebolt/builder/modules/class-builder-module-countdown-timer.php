...
/**
 * class Tm_Codebolt_Builder_Module_Countdown_Timer.
 */
class Tm_Codebolt_Builder_Module_Countdown_Timer extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Countdown Timer', 'tm-codebolt' );
		...
		$this->advanced_options = array(
			'fonts' => array(
				'header' => array(
					'label'    => esc_html__( 'Header', 'tm-codebolt' ),
					'css'      => array(
						'main' => "{$this->main_css_element} h4",
					),
				),
				'numbers' => array(
					'label'    => esc_html__( 'Numbers', 'tm-codebolt' ),
					'css'      => array(
				...
				'label' => array(
					'label'    => esc_html__( 'Label', 'tm-codebolt' ),
					'css'      => array(
		...
		$this->custom_css_options = array(
			'container' => array(
				'label'    => esc_html__( 'Container', 'tm-codebolt' ),
			...
			'timer_section' => array(
				'label'    => esc_html__( 'Timer Section', 'tm-codebolt' ),
				'selector' => '.section',
			),
		);
	}
	...
	public function get_fields() {
		$fields = array(
			'title' => array(
				'label'           => esc_html__( 'Countdown Timer Title', 'tm-codebolt' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'This is the title displayed for the countdown timer.', 'tm-codebolt' ),
			),
			'date_time' => array(
				'label'           => esc_html__( 'Countdown To', 'tm-codebolt' ),
				'type'            => 'date_picker',
				'option_category' => 'basic_option',
				'description'     => tm_get_safe_localization(
					sprintf(
						...
						esc_html__( 'This is the date the countdown timer is counting down to. Your countdown timer is based on your timezone settings in your ', 'tm-codebolt' ),
						esc_html__( 'WordPress General Settings', 'tm-codebolt' )
					)
				),
			),
			'use_background_color' => array(
				'label'           => esc_html__( 'Use Background Color', 'tm-codebolt' ),
				'type'            => 'yes_no_button',
				...
				'description' => esc_html__( 'Here you can choose whether background color setting below should be used or not.', 'tm-codebolt' ),
			),
			'background_color' => array(
				'label'             => esc_html__( 'Background Color', 'tm-codebolt' ),
				'type'              => 'color-alpha',
				'depends_default'   => true,
				'description'       => esc_html__( 'Here you can define a custom background color for your countdown timer.', 'tm-codebolt' ),
			),
			'timer_layout' => array(
				'label'             => esc_html__( 'Layout', 'tm-codebolt' ),
				'type'              => 'select',
				'options'           => array(
					'flat'   => esc_html__( 'Flat', 'tm-codebolt' ),
					'circle' => esc_html__( 'Circle', 'tm-codebolt' ),
				),
				'affects'           => array(
			...
			'circle_background' => array(
				'label'               => esc_html__( 'Circle Background Color', 'tm-codebolt' ),
				'type'                => 'color-alpha',
			...
			'use_circle_border' => array(
				'label'           => esc_html__( 'Use Circle Border', 'tm-codebolt' ),
				'type'            => 'yes_no_button',
...
new tm_codebolt_Builder_Module_Countdown_Timer;
