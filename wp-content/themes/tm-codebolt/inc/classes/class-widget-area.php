...
if ( ! class_exists( 'Tm_Codebolt_Widget_Area' ) ) {

	/**
	 * class Tm_Codebolt_Widget_Area.
	 */
	class Tm_Codebolt_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'tm_codebolt_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'tm_codebolt_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'tm_codebolt_widget_area_classes', $classes, $area_id );
	...
	/**
	 * Returns instance of widget area.
	 *
	 * @return object
	 */
	function tm_codebolt_widget_area() {
		return tm_codebolt_Widget_Area::get_instance();
	}

	tm_codebolt_widget_area();
}
