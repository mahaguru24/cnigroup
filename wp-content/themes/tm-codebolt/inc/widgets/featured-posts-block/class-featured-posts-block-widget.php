...
if ( ! class_exists( 'tm_codebolt_Featured_Posts_Block_Widget' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class tm_codebolt_Featured_Posts_Block_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			$this->widget_name        = esc_html__( 'Featured Posts Block', 'tm-codebolt' );
			$this->widget_description = esc_html__( 'This widget displays latest posts', 'tm-codebolt' );
			$this->widget_id          = 'tm_codebolt_widget_featured_posts_block';
			...
			foreach( $layouts as $id => $layout ) {
				$layout_options[ $id ] = array(
					'label'   => $layout['name'],
					'img_src' => TM_CODEBOLT_THEME_URI . '/assets/images/admin/widgets/featured-posts-block/' . $id . '.svg',
				);
			}
			...
			$this->settings = array(
				...
				'layout' => array(
					...
					'label'   => esc_html__( 'Layout', 'tm-codebolt' ),
					'options' => $layout_options,
				),
				'posts_ids' => array(
					'type'  => 'text',
					'value' => '',
					'label' => esc_html__( 'Posts IDs (Optional)', 'tm-codebolt' ),
				),
				'checkboxes'     => array(
					'type'  => 'checkbox',
					'label' => esc_html__( 'Post Meta', 'tm-codebolt' ),
					'value' => array(
						'title'      => 'true',
						'excerpt'    => 'true',
						'categories' => 'true',
					...
					'options' => array(
						'title'      => esc_html__( 'Show title', 'tm-codebolt' ),
						'excerpt'    => esc_html__( 'Show excerpt', 'tm-codebolt' ),
						'categories' => esc_html__( 'Show categories', 'tm-codebolt' ),
						'tags'       => esc_html__( 'Show tags', 'tm-codebolt' ),
						'author'     => esc_html__( 'Show author', 'tm-codebolt' ),
						'date'       => esc_html__( 'Show date', 'tm-codebolt' ),
					),
				),
				'title_length' => array(
					'type'      => 'stepper',
					'value'     => 12,
					'min_value' => 1,
					'label'     => esc_html__( 'Title length (chars)', 'tm-codebolt' ),
				),
				'excerpt_length' => array(
					'type'      => 'stepper',
					'value'     => 15,
					'min_value' => 1,
					'label'     => esc_html__( 'Excerpt length (words)', 'tm-codebolt' ),
				),
			);
		...
		public function render_layout( $options = array() ) {
			...
			$item_template = locate_template(  apply_filters( 'tm_codebolt_featured_posts_block_widget_view_dir', 'inc/widgets/featured-posts-block/views/item.php' ), false, false );
			 ...
			 */
			$query = apply_filters( 'tm_codebolt_featured_posts_block_query', $query, $this->instance );
		...
		public function get_layouts() {
			return array(
				'layout-1' => array(
					'name'   => esc_html__( 'Type #1', 'tm-codebolt' ),
					'amount' => 5,
					'markup' => array(
						array(
							'type'  => 'item',
				...
				'layout-2' => array(
					'name'   => esc_html__( 'Type #2', 'tm-codebolt' ),
					'amount' => 5,
					'markup' => array(
						array(
							'type'  => 'item',
				...
				'layout-3' => array(
					'name'   => esc_html__( 'Type #3', 'tm-codebolt' ),
					'amount' => 4,
					'markup' => array(
						array(
							'type'  => 'item',
				...
				'layout-4' => array(
					'name'   => esc_html__( 'Type #4', 'tm-codebolt' ),
					'amount' => 4,
					'markup' => array(
						array(
							'type'  => 'item',
				...
				'layout-5' => array(
					'name'   => esc_html__( 'Type #5', 'tm-codebolt' ),
					'amount' => 3,
					'markup' => array(
						array(
							'type'  => 'item',
	...
	add_action( 'widgets_init', 'tm_codebolt_register_featured_posts_block_widget' );

	if ( false === function_exists( 'tm_codebolt_register_featured_posts_block_widget' ) ) {
		/**
		 * Register featured posts block widget.
		 */
		function tm_codebolt_register_featured_posts_block_widget() {
			register_widget( 'tm_codebolt_Featured_Posts_Block_Widget' );
		}
	}
}
