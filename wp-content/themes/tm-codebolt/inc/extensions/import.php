...
add_action( 'cherry_data_import_home_regex_replace', 'tm_codebolt_remap_shortcodes' );
add_action( 'cherry_data_import_remap_posts',        'tm_codebolt_remap_menus' );
 ...
 * @return array
 */
function tm_codebolt_remap_shortcodes( $regex ) {
 ...
 */
function tm_codebolt_remap_menus( $posts ) {
 ...
 * @param array $posts post remapping array.
 */
function tm_codebolt_remap_timetable( $posts ) {
