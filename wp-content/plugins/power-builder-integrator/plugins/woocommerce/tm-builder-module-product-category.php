<?php
class Tm_Builder_Product_Category extends Tm_Builder_Module {

	function init() {
		$this->name = esc_html__( 'Product Category', 'power-builder-integrator' );
		$this->icon = 'f07a';
		$this->slug = 'tm_pb_product_category';
	...
	function get_fields() {
		...
		$fields = array(
			...
			'category' => array(
				'label'           => esc_html__( 'Category slug', 'power-builder-integrator' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
			),
			'operator' => array(
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$callback = power_builder_integrator()->get_shortcode_cb( 'woocommerce', 'product_category' );
...
new Tm_Builder_Product_Category;
