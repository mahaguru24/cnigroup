<?php
class Tm_Builder_Sale_Products extends Tm_Builder_Module {

	function init() {
		$this->name = esc_html__( 'Sale Products', 'power-builder-integrator' );
		$this->icon = 'f07a';
		$this->slug = 'tm_pb_sale_products';
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$callback = power_builder_integrator()->get_shortcode_cb( 'woocommerce', 'sale_products' );
