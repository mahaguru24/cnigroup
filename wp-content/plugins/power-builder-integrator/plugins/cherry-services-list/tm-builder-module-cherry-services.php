...
class Tm_Builder_Cherry_Services extends Tm_Builder_Module {
	...
	function init() {
		...
		$this->name = esc_html__( 'Services', 'power-builder-integrator' );
		$this->icon = 'f0eb';
	...
	function get_fields() {
		...
		$fields = array(
			...
			'id' => array(
				...
				'option_category' => 'basic_option',
				'type'            => 'text',
				'description'     => esc_html__( 'Enter comma separated post IDs you would like to include. Example: 256, 472, 23, 6', 'power-builder-integrator' ),
			),
			...
			'show_filters' => array(
				'label'             => esc_html__( 'Show filter by categorys', 'power-builder-integrator' ),
				'type'              => 'yes_no_button',
				'option_category'   => 'configuration',
				'options'           => array(
			...
			'show_media' => array(
				'label'   => esc_html__( 'Show featured media (image or icon)', 'power-builder-integrator' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'on'  => esc_html__( 'Yes', 'power-builder-integrator' ),
